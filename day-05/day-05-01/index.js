...
const main = () => {
  ...
  inputbody.forEach((cmd) => {
    ...
    for(var i=0; i<quantity; i++){
      const removedContainer = containerRows[fromIndex].splice(containerRows[fromIndex].length-1, containerRows[fromIndex].length);
      containerRows[toIndex].push(removedContainer[0])
    }
  })
